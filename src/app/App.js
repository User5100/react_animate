...
class App extends Component {
  ...
  handleDisplayInputBox(index) {
    ...
    this.setState({ showInputForNewWord: true, indexOfWordBeforeInsert: index }, () => {
  ...
  handleTextInputOnEnter(event) {
        ...
        words = [...words, ...segment.words]
			...
			userInput = userInput.map((wordStr, i) => {
				return {
					word: wordStr,
					timestamp: null,
					speakerNo: words[this.state.indexOfWordBeforeInsert].speakerNo,
	...
	handleEditOfExistingWord(words, userInput) {
		console.log('Handle editing on existing word', 'userInput', userInput)
                               ...
                               .filter(key => {
                                  if(key.code === 'Backspace' || key.code === 'Delete') {
                                    ...
                                    return 0
															 ...
															 //Only trigger delete if inputBox is hidden
															 .filter(() => !this.state.showInputForNewWord) 
